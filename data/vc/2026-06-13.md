# VC & Research Daily Fetch — 2026-06-13
...
- [The SaaS GTM glossary that no one has written yet](https://www.insightpartners.com/ideas/saas-gtm-glossary/)
...
> **摘要:** Perspectives
Poetic: Turning Enterprise Procedures into Evolving Software
June 10, 2026
By
Leigh Marie Braswell
Most of the attention in AI applications has gone to categories like writing code, searching enterprise data, and answering customer questions. But there is another category of work, far larger and far less touched by software: the complex, multi-hour processes that keep large companies running. Think insurance underwriting, supply chain operations, financial compliance. Workflows governed by hundreds of edge cases and undocumented rules that live in the heads of experts who have spent years mastering them.
Poetic is building a platform to automate these processes with the level of accuracy that regulated industries actually require. Their core insight is that the hardest part is not the model. It is translating deep human expertise into software that can operate reliably. Poetic built its own programming language that lets operators define workflows in plain English, while the system converts that into deterministic, near-tokenless execution under the hood. At a moment when companies like Uber are
openly questioning whether ballooning AI token spend is worth it
, Poetic’s architecture is a meaningful differentiator.
I’ve known Markie Wagner, Poetic’s founder, for many years. We first met when she was at Waymo, and she has been one of the most thoughtful and prescient voices on AI I’ve encountered since. Before Poetic, Markie founded Delphi, an ML consultancy that d
